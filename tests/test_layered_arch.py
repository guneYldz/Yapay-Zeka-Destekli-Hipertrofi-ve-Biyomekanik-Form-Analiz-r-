"""
Combined Tests for Layered Architecture Form Analyzer
Contains tests for Domain, Application, Data, and Presentation layers.
"""

import unittest

from domain.entities import FormIssue, Joint, Point3D, PoseFrame, RiskLevel, ExerciseType
from domain.geometry import calculate_angle_2d, calculate_angle_3d, calculate_vertical_angle
...
from data.adapters import MediaPipePoseAdapter, MockPoseAdapter
...
class TestSquatRules(unittest.TestCase):
...
class TestBenchPressRules(unittest.TestCase):
...
class TestAnalyzeFormUseCase(unittest.TestCase):
...
class TestMockPoseAdapter(unittest.TestCase):
