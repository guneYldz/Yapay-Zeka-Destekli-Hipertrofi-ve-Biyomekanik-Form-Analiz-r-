...
from domain.entities import ExerciseType, FormIssue, Joint, PoseFrame, RiskLevel
from domain.geometry import calculate_angle_2d, calculate_vertical_angle
...
class RuleRegistry:
    ...
    def get_rules_for(exercise: ExerciseType) -> List[ValidationRule]:
        ...
        if exercise == ExerciseType.BENCH_PRESS:
            return [BenchPressBarPathRule()]
        return []
